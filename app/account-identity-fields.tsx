...
export function AccountIdentityFields({ values, birthDateReadOnly = false }: { values?: AccountIdentityValues; birthDateReadOnly?: boolean }) {
  ...
  return <>
    <div className="form-grid form-grid-two account-identity-required">
    ...
    <fieldset className="account-identity-optional"><legend>Datos opcionales</legend><p>Agrega solo lo que quieras registrar ahora. La ciudad sigue siendo una ciudad chilena aunque uses documento extranjero.</p><div className="form-grid form-grid-two">
