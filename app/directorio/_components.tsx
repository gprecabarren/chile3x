...
const angelisNetBadgeImage = "/angelisnet-logo.webp";
  ...
  return (
    <>
      ...
      <header className={`site-header public-header${hasAnySession ? " has-session" : ""}`}>
        <Link className="brand" href="/" aria-label="Chile3X, inicio"><Image src="/chile3x-logo-primary-320.webp" alt="Chile3X" width={320} height={112} priority unoptimized /></Link>
...
export async function PublicFooter() {
  ...
  return (
    <footer className="public-footer">
      <div className="public-footer-brand"><Link className="public-footer-logo" href="/" aria-label="Chile3X, inicio"><Image src="/chile3x-logo-primary-320.webp" alt="Chile3X" width={320} height={112} unoptimized /></Link><p>Directorio de escorts y damas de compañía para adultos. Los acuerdos ocurren directamente entre visitantes y anunciantes.</p></div>
