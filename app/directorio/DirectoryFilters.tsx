...
export function DirectoryFilters({ action, filters, pinnedCity, pinnedRegion, showType = false, types = ["escort", "agency", "rental"], showEscortFilters = true }: DirectoryFiltersProps) {
