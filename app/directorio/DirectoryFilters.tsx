  ...
  return (
    <form className="directory-filters" action={action} method="get">
      ...
      <div className="filter-grid">
        <label className="filter-full">Buscar por nombre<input name="nombre" type="search" minLength={2} maxLength={80} defaultValue={filters.name ?? ""} placeholder="Ej. Valentina, Camila o Alejandra" /></label>
