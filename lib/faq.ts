...
export const defaultFaqEntries: FaqEntry[] = [
  ...
  { question: "¿Cómo funciona el chat interno y el indicador Online?", answer: "El chat interno exige una cuenta activa y vincula cada conversación con el anuncio desde el que se inició. Los participantes pueden ver el historial, silenciar avisos o bloquear mensajes nuevos. Si la otra cuenta se deshabilita o elimina, aparece como “Usuario de Chile3X”, se ocultan sus referencias identificables y ya no se pueden enviar mensajes nuevos. Online solo indica actividad reciente de la cuenta propietaria; desaparece automáticamente al dejar de interactuar y no revela una hora exacta." },
  { question: "¿Cómo usa Chile3X mi ubicación para ordenar anuncios?", answer: "El selector permite elegir región o ciudad manualmente. Si pulsas “Usar mi ubicación”, el navegador solicita permiso y compara las coordenadas localmente con las ciudades cubiertas. Chile3X guarda solo la ciudad preferida para ordenar resultados; no conserva las coordenadas GPS." },
