    ...
    <form action={action} method="post" className="profile-form">
      ...
      {type === "escort" && (
        <section className="profile-form-section">
          ...
          <div className="form-grid form-grid-three">
            <label>Género<input name="gender" maxLength={40} defaultValue={metadataValue(initial, "gender")} /></label>
            <label>Edad<input name="age" type="number" min="18" max="99" defaultValue={metadataValue(initial, "age")} /></label>
            ...
            <label>Estatura (cm)<input name="height_cm" type="number" min="0" max="250" defaultValue={metadataValue(initial, "height_cm")} /></label>
            <label>Peso (kg)<input name="weight_kg" type="number" min="0" max="300" defaultValue={metadataValue(initial, "weight_kg")} /></label>
          </div>
        </section>
      )}
